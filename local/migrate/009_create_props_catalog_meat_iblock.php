 ...
 */
class AddPropertiesCatalogMeatIBlockMigration extends AbstractIBlockPropertyMigration
{
    /**
     * {@inheritdoc}
     */
...
$iBlockMigrations = new AddPropertiesCatalogMeatIBlockMigration(
    $environment->get('catalogMeatIBlockId')
);
