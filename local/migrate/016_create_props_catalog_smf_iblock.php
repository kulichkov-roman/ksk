<?php
/**
 * Миграция добавляет свойства к инфоблоку «Каталог: полуфабрикаты»
 */
...
/**
 * Class AddPropertiesCatalogSmfIBlockMigration
 */
class AddPropertiesCatalogSmfIBlockMigration extends AbstractIBlockPropertyMigration
{
    /**
     * {@inheritdoc}
     */
...
$iBlockMigrations = new AddPropertiesCatalogSmfIBlockMigration(
    $environment->get('catalogSmfIBlockId')
);
