<?php
/**
 * Создает инфоблок «SEO описание разделов»
 *
...
class CreateSeoIBlockMigration extends AbstractIBlockMigration
{
	...
	public function up()
	{
		...
		try {
			...
			$logger->log(
				sprintf('IBlock has been created. Id: "%s". Add to "seoSecDescIBlockId"', $this->iblockId)
			);
	...
	public function down()
	{
		...
		$this->deleteIBlock($environment->get('seoSecDescriptionIBlockId'));
